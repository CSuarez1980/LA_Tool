...
Public Class Connection
    ...
    Public Function GetConnectionString() As String
        ...
        Return "Data Source=172.28.23.2,1528; Initial Catalog=LA Tool;User ID=oemsadmin; Password=@bhiram1"

        'Return "Data Source=172.18.27.12,1528; Initial Catalog=LA Tool;User ID=oemsadmin; Password=@bhiram1"
