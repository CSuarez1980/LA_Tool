Public Class frm013
    ...
    Private Sub frm013_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i%

        table = cn.RunSentence("Select * From vstOATracking Where OwnerMail = '" & cn.GetUserMail & "' order by OA").Tables(0)
