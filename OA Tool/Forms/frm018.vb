Public Class frm018
    ...
    Private Sub frm018_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i%
        Tabla = cn.RunSentence("Select * From vstContrato_MasterData Where PDT_OA <> PDT_MD and OwnerMail = '" & cn.GetUserMail & "'").Tables(0)
