Public Class frm005
    ...
    Private Sub frm005_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Access.CloseCurrentDatabase()
        Access.Quit(Global.Access.AcQuitOption.acQuitSaveAll)
    End Sub


    Private Sub frm005_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i%

        Table = cn.RunSentence("Select * From vstContratosVencidos Where OwnerMail = '" & cn.GetUserMail & "'")
    ...
    Private Sub frm005_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        Me.dtgContratos.Width = Me.Width - 20
        Me.dtgContratos.Height = Me.Height - 150
    End Sub

    Private Sub ToolStripButton3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton3.Click
        'Mismo código que en la pantalla [004],[008],[009]
        Dim i%
        Dim J%
        Dim x%
