Public Class frm006
    ...
    Private Sub frm006_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Access.CloseCurrentDatabase()
        Access.Quit(Global.Access.AcQuitOption.acQuitSaveAll)
    End Sub

    Private Sub frm006_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i%

        Table = cn.RunSentence("Select * From vstOwners order by OA").Tables(0)
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        ...
        '    cn.ExecuteInServer("Update contratos set LastUpdate = '" & Me.dtgContratos.Rows(i).Cells("Fecha").Value & "', updated = 1, estado = 6 Where OA = " & Me.dtgContratos.Rows(i).Cells("OA").Value)
        'Next
