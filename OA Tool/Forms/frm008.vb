Public Class frm008
    ...
    Private Sub frm008_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Access.CloseCurrentDatabase()
        Access.Quit(Global.Access.AcQuitOption.acQuitSaveAll)
    End Sub

    Private Sub frm008_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Dim i%

        Table = cn.RunSentence("Select * From vstContratosPorVencer")
    ...
    Private Sub frm008_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        Me.dtgContratos.Width = Me.Width - 20
        Me.dtgContratos.Height = Me.Height - 150
    End Sub

    Private Sub ToolStripButton3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton3.Click
        'Mismo código que en la pantalla [004],[005],[009]
        Dim i%
        Dim J%
        Dim x%
        ...
        '    If Me.dtgContratos.Rows(i).Selected Then
        '        Access.Run("GetBlueForm", CStr(Me.dtgContratos.Rows(i).Cells("Vendor").Value), FolderBrowserDialog.SelectedPath & "\" & CStr(Me.dtgContratos.Rows(i).Cells("Vendor").Value) & " - " & Me.dtgContratos.Rows(i).Cells("Name").Value & ".xls")
        '        cn.ExecuteInServer("Update Contratos Set InProcess = 1 Where vendor = " & CStr(Me.dtgContratos.Rows(i).Cells("Vendor").Value))
        '    End If
        'Next
