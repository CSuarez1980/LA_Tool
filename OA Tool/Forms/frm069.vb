Public Class frm069
    ...
    Public FiscalStart As String = Nothing
    Public FiscalEnd As String = Nothing
    ...
    Private Sub BGL7P_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BGL7P.DoWork
        ...
        If SAP.Conected Then
            ...
            Var = cn.RunSentence("Select Variant, TNumber From IC_SAP_Variant Where ((Module = 'Unblock') And (Active = 1) And (SAPBox = '" & Box & "'))").Tables(0)

            For Each row As DataRow In Var.Rows
                Try
                    dt = SAP.Get_SAP_Unblocked_Report(row("Variant"), row("TNumber"), Box, StartDate, EndDate, FiscalStart, FiscalEnd, PDFPath)
                    ...
                    If Not dt Is Nothing Then
                        ...
                        cn.AppendTableToSqlServer("IC_Unbloqued_Report", dt)
    ...
    Private Sub cmdDownload_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDownload.Click
        ...
        FiscalStart = txtFiscalFrom.Text
        FiscalEnd = txtFiscalTo.Text

        cn.RunSentence("Delete From IC_Unbloqued_Report Where TNumber = '" & gsUsuarioPC & "'")
    ...
    Private Sub CheckBG()
        If (Not BGL7P.IsBusy) AndAlso (Not BGG4P.IsBusy) AndAlso (Not BGGBP.IsBusy) AndAlso (Not BGL6P.IsBusy) AndAlso (Not BGN6P.IsBusy) Then
            ...
            Data = cn.RunSentence("Select * From IC_Unbloqued_Report Where TNumber = '" & gsUsuarioPC & "'").Tables(0)
    ...
    Private Sub GBG4P_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BGG4P.DoWork
