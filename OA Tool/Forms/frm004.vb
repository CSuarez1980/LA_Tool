Public Class frm004
    ...
    Private Sub frm004_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Access.CloseCurrentDatabase()
        Access.Quit(Global.Access.AcQuitOption.acQuitSaveAll)
    End Sub

    Private Sub frm004_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Dim i%

        Table = cn.RunSentence("Select * From vstContratosPorVencer Where OwnerMail = '" & cn.GetUserMail & "'")
        ...
        Me.txtInicio.Text = Today()
        Me.txtFinal.Text = Today.AddDays(90)
    ...
    Private Sub frm004_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        Me.dtgContratos.Width = Me.Width - 20
        Me.dtgContratos.Height = Me.Height - 150
    End Sub

    Private Sub ToolStripButton3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton3.Click
        'Mismo código que en la pantalla [005],[008],[009]
        Dim i%
        Dim J%
        Dim x%
        ...
        For i = 0 To Me.dtgContratos.RowCount - 1
            ...
            If Me.dtgContratos.Rows(i).Selected Then
                ...
                If Not Found Then
                    ...
                    OA = cn.RunSentence("Select oa from vstOwners Where Vendor = " & CStr(Me.dtgContratos.Rows(i).Cells("Vendor").Value)).Tables(0)
